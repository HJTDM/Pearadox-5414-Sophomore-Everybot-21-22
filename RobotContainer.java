...
public class RobotContainer {
  ...
  public static final Intake m_intake = Intake.getInstance();
  ...
  private void configureButtonBindings() {
    ...
    button2.whileHeld(new RunCommand(m_intake::IntakeIn, m_intake));
    button1.whileHeld(new RunCommand(m_intake::IntakeOut, m_intake));
  }
